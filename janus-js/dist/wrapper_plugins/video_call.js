...
var JanusVideoCallPlugin = /** @class */ (function (_super) {
    ...
    /**
     * Accept the call from registered remote user
     * @param {RTCSessionDescription} answer- webrtc answer of your choice specifying whether to send video or audio or both
     * */
    JanusVideoCallPlugin.prototype.accept = function (answer) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.send({
